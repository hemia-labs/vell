...
export class Migration1776814724224 implements MigrationInterface {
    name = 'Migration1776814724224'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."content_type_fields_field_type_enum" AS ENUM('text', 'textarea', 'number', 'boolean', 'date', 'image', 'file')`);
